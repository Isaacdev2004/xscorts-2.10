...
import {
  Form, Input, Select, Button, Breadcrumb, message, InputNumber, Upload
} from 'antd';
...
class PostUpdate extends PureComponent<any> {
  ...
  render() {
    const { post, submitting, imageUrl } = this.state;
    return (
      <>
        <Head>
        ...
        <Page>
          {!post ? (
            ...
            >
              ...
              <Form.Item name="canonicalUrl" label="canonicalUrl">
                <Input minLength={1} />
              </Form.Item>
              ...
              <Form.Item label="Image">
                ...
                >
                  {imageUrl ? <img src={imageUrl} alt="avatar" style={{ width: '100%' }} /> : 'Select image'}
                </Upload>
              </Form.Item>
