  ...
  },
  {
    ...
    * worker(data: IReduxAction<any>) {
      try {
        ...
        yield messageService.deleteMessage(conversationId, messageId);
        yield put(deleteMessageSuccess({ conversationId, messageId }));
      } catch (e) {
        const error = yield Promise.resolve(e);
        yield put(deleteMessageFail(error));
        message.error('Delete mission, please againt');
      }
    }
  },
  {
  ...
  },
  {
    ...
    * worker(req: IReduxAction<any>) {
      try {
        ...
        yield put(updateLastMessage({ conversationId, message: data.text }));
      } catch (e) {
